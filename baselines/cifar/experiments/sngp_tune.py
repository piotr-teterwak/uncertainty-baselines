...
def get_sweep(hyper):
  return hyper.product([
      # hyper.sweep('gp_input_normalization', hyper.categorical([False, True])),
      # hyper.sweep('gp_mean_field_factor', hyper.categorical([-1, 25.0])),
      # hyper.sweep('drop_remainder_for_eval', hyper.categorical([False, True])),

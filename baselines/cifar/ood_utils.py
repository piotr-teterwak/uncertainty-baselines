...
def create_ood_metrics(ood_dataset_names):
  ...
  for dataset_name in ood_dataset_names:
    ...
    ood_metrics.update(
        # {ood_dataset_name: ood_utils.OODMetric('msp')}
        {
...
def load_ood_datasets(ood_dataset_names,
  ...
  for ood_dataset_name in ood_dataset_names:
    ...
    steps[
        f'ood/{ood_dataset_name}'] = ood_dataset_builder.in_distribution_num_examples // batch_size + ood_dataset_builder.ood_num_examples // batch_size
